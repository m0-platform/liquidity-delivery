...
impl ConfigureDestination<'_> {
    fn validate(&self, dest_chain_id: u32, is_supported: bool, finality_buffer: Option<u64>) -> Result<()> {
    ...
    #[access_control(ctx.accounts.validate(dest_chain_id, is_supported, finality_buffer))]
    pub fn handler(
        ctx: Context<Self>,
        dest_chain_id: u32,
        is_supported: bool,
